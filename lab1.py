...
#Q2. Write a program that accepts two matrices A and B as input and returns their product AB. Check if A & B are multipliable; if not, return an error message.
...
def transpose_matrix(matrix):
    ...
    return transposed
#Q5. Generate a list of 100 random numbers between 100 and 150. Find the mean, median and mode for these numbers
